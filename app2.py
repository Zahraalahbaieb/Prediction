...
st.write("This tool predicts whether a startup will be successful based on various inputs related to companies operational, financial, and strategic aspects. the details below and click 'Predict' to see the results.")
user_input={}
